...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, isCompleted, time];
  @override
...
class Task extends DataClass implements Insertable<Task> {
  ...
  @override
  int get hashCode => Object.hash(id, title, isCompleted, time);
  @override
...
abstract class _$TaskDatabase extends GeneratedDatabase {
  ...
  late final NoteDao noteDao = NoteDao(this as TaskDatabase);
  @override
...
class $$NotesTableFilterComposer extends Composer<_$TaskDatabase, $NotesTable> {
...
class $$NotesTableOrderingComposer
    extends Composer<_$TaskDatabase, $NotesTable> {
...
class $$NotesTableTableManager
    extends
        RootTableManager<
          ...
          (Note, BaseReferences<_$TaskDatabase, $NotesTable, Note>),
          Note,
          PrefetchHooks Function()
        > {
  $$NotesTableTableManager(_$TaskDatabase db, $NotesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
